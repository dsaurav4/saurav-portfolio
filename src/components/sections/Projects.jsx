      ...
      <div className="max-w-5xl mx-auto px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div className="p-6 rounded-xl border border-white/10 hover:-translate-y-1 hover:border-blue-500/30 hover:shadow-[0_2px_8px_rgba(59,130,246,0.2)] transition">
            <h3 className="text-xl font-bold mb-2">The Finacne App</h3>
            <p className="text-gray-400 mb-4">
              The Finance App is a personal finance management tool designed to
              simplify budgeting, expense tracking, and financial
              decision-making.
            </p>
          ...
          <div className="p-6 rounded-xl border border-white/10 hover:-translate-y-1 hover:border-blue-500/30 hover:shadow-[0_2px_8px_rgba(59,130,246,0.2)] transition">
            ...
            <p className="text-gray-400 mb-4">
              This project is a comprehensive solution that translates assembly
              language programs into machine language and then emulates their
              execution. It's built around a core of two primary components: an
          ...
          <div className="p-6 rounded-xl border border-white/10 hover:-translate-y-1 hover:border-blue-500/30 hover:shadow-[0_2px_8px_rgba(59,130,246,0.2)] transition">
            ...
            <p className="text-gray-400 mb-4">
              ...
              Yahtzee. The program supports both human and computer players and
              includes various features such as game serialization, AI
          ...
          <div className="p-6 rounded-xl border border-white/10 hover:-translate-y-1 hover:border-blue-500/30 hover:shadow-[0_2px_8px_rgba(59,130,246,0.2)] transition">
            ...
            <p className="text-gray-400 mb-4">
              ...
              diabetes using the 2015 Behavioral Risk Factor Surveillance System
              (BRFSS) dataset. The project focuses on assessing the impact of
              various demographic and lifestyle factors, such as Body Mass Index
              (BMI), exercise frequency, and dietary habits, on the likelihood
          ...
          <div className="p-6 rounded-xl border border-white/10 hover:-translate-y-1 hover:border-blue-500/30 hover:shadow-[0_2px_8px_rgba(59,130,246,0.2)] transition">
            ...
            <p className="text-gray-400 mb-4">
              This project aims to analyze and predict stroke occurrences using
              the "Stroke Prediction Dataset" from Kaggle. Various demographic
              and health-related factors are examined to uncover insights into
              stroke risk factors. Logistic regression analysis is utilized to
              highlight significant predictors of stroke occurrence, aiding in
              the understanding of the impact of these factors on stroke risk.
            </p>
            <div className="flex flex-wrap gap-2 mb-4">
              {[
                "Python",
